...
var incompleteTaskHolder=document.querySelector(".new-task__list");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".done-task__list");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-item input-text task__input-text";
